...
local sections = {
  ...
  x = { desc = get_icon("Window", 1, true) .. "LATEX" },
  T = { desc = get_icon("Search", 1, true) .. "Telescope" },
  D = { desc = get_icon("Git", 1, true) .. "DOCstring" },
}
...
maps.n["<leader>nd"] = { "<cmd>NoiceDismiss<cr>", desc = "Dismiss Noice Message" }
...
maps.n["<leader>,"] = { ":" }
maps.n["<leader>."] = { "/" }
-- maps.n["<leader>,"] = {"<cmd>FineCmdline<cr>"}

-- maps.n["<leader>x"] = { "<cmd>TexlabBuild<cr>", desc = "LaTex Compile"}
maps.n["<F2>"] = { "<cmd>MundoToggle<cr>" }
...
--section X Latex Vimtex
maps.n["<leader>x"] = sections.x
maps.n["<leader>xc"] = { "<cmd>VimtexCompile<cr>", desc = "Vimtex Compile" }
maps.n["<leader>xC"] = { "<cmd>VimtexClean<cr>", desc = "Clean" }
maps.n["<leader>xs"] = { "<cmd>VimtexStopAll<cr>", desc = "Stop All" }
maps.n["<leader>xm"] = { "<cmd>MarkdownPreviewToggle<cr>", desc = "MARKDOWN" }

-- TODO
maps.n["<leader>T"] = sections.T
maps.n["<leader>Ta"] = { "<cmd>Telescope<cr>", desc = "Telescope all" }
maps.n["<leader>Tq"] = { "<cmd>TodoQuickFix<cr>", desc = "TODO Quickfix" }
maps.n["<leader>Tt"] = { "<cmd>TodoTelescope<cr>", desc = "Todo Telescope" }
...
if is_available "gitsigns.nvim" then
  ...
  maps.n["<leader>gB"] = { "<cmd>ToggleBlameLine<cr>", desc = "Toggle Blame line" }
  ...
  maps.n["<leader>gf"] = { "<cmd>Flogsplit<cr>", desc = "Flog split" }
end
...
if is_available "telescope.nvim" then
  ...
  maps.n["<leader>ft"] = { function() require("telescope.builtin").tags() end, desc = "Find tags" }
  maps.n["<leader>fF"] = {
    function() require("telescope.builtin").find_files { hidden = true, no_ignore = true } end,
    desc = "Find all files",
  }
  maps.n["<leader>fh"] = { function() require("telescope.builtin").help_tags() end, desc = "Find help" }
  maps.n["<leader>fj"] = { "<cmd>Telescope jumplist<cr>", desc = "Jumps list" }
  ...
  maps.n["<leader>fe"] =
    ...
    { function() require("telescope.builtin").current_buffer_fuzzy_find { enable_preview = true } end, desc = "Find in Buffer" }
...
if is_available "toggleterm.nvim" then
  ...
  maps.n["<leader>tv"] = { "<cmd>ToggleTerm size=80 direction=vertical<cr>", desc = "ToggleTerm vertical split" }
    maps.n["<leader>tt"] = { "<cmd>w!<cr><cmd>TermExec cmd='clear && python3 %'<cr>", desc = "Run Python" }
...
if is_available "nvim-ufo" then
  ...
  maps.n["z0"] = { "<cmd>set foldlevel=0<cr>" }
  maps.n["z1"] = { "<cmd>set foldlevel=1<cr>" }
  maps.n["z2"] = { "<cmd>set foldlevel=2<cr>" }
  maps.n["z3"] = { "<cmd>set foldlevel=3<cr>" }
  maps.n["z4"] = { "<cmd>set foldlevel=4<cr>" }
  maps.n["z5"] = { "<cmd>set foldlevel=5<cr>" }
  maps.n["z6"] = { "<cmd>set foldlevel=6<cr>" }
  maps.n["z7"] = { "<cmd>set foldlevel=7<cr>" }
  maps.n["z8"] = { "<cmd>set foldlevel=8<cr>" }
end
